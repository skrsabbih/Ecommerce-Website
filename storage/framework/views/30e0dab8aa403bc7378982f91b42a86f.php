                            ...
                            <div class="tab-pane fade" id="pills-profiles" role="tabpanel"
                                ...
                                <div class="wsus__login">
                                    <form method="POST" action="<?php echo e(route('register')); ?>">
                                        ...
                                        <div class="wsus__login_input">
                                            <i class="fas fa-user-tie"></i>
                                            <input id="name" name="name" value="<?php echo e(old('name')); ?>" type="text" placeholder="Name">
                                        </div>
        
  
                                        <div class="wsus__login_input">
                                            <i class="far fa-envelope"></i>
                                            <input id="email" name="email" type="text" value="<?php echo e(old('email')); ?>" placeholder="Email">
                                        </div>
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\project\ecommerce\resources\views/auth/login.blade.php ENDPATH**/ ?>