        ...
        <div class="row">
          <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
            <div class="login-brand">
              <img src="<?php echo e(asset('backend/assets/img/stisla-fill.svg')); ?>" alt="logo" width="100" class="shadow-light rounded-circle">
            </div>
...
</html><?php /**PATH D:\project\ecommerce\resources\views/admin/auth/login.blade.php ENDPATH**/ ?>